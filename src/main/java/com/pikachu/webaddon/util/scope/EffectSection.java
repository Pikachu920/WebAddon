...
public abstract class EffectSection extends Condition {
    ...
    public void setTrigger(TriggerSection trigger) {
    ...
    public void loadSection(boolean setNext) {
        if (section != null) {
            ...
            trigger = Util.loadSectionNode(section, this.toString(null, false), true);
            if (setNext) {
    ...
    /**
     * Returns this scope as it appears in the script.
     * Useful for {@link ch.njol.skript.lang.Debuggable#toString(Event, boolean)}.
     * @return The scope as it appears in the script
     */
